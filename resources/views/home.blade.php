...
<section>
    <article>
        <div class="m-3">
            <div class="container-fluid card card-body shadow p-3 mb-5 bg-body-tertiary rounded">
                <div class="d-flex justify-content-end">
                    <button type="button" data-bs-toggle="modal"data-bs-target="#Agregarmodal" class="btn btn-primary">Agregar</button>
                </div>
